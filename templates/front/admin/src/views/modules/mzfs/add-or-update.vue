	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="付款人数" prop="realsales">
					<el-input v-model="ruleForm.realsales" placeholder="付款人数" clearable  :readonly="ro.realsales"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="付款人数" prop="realsales">
					<el-input v-model="ruleForm.realsales" placeholder="付款人数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商家" prop="shopname">
					<el-input v-model="ruleForm.shopname" placeholder="商家" clearable  :readonly="ro.shopname"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="商家" prop="shopname">
					<el-input v-model="ruleForm.shopname" placeholder="商家" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="尺码" prop="chima">
					<el-input v-model="ruleForm.chima" placeholder="尺码" clearable  :readonly="ro.chima"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="尺码" prop="chima">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="货号" prop="huohao">
					<el-input v-model="ruleForm.huohao" placeholder="货号" clearable  :readonly="ro.huohao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="货号" prop="huohao">
					<el-input v-model="ruleForm.huohao" placeholder="货号" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="颜色分类" prop="ysfl">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="颜色分类"
					  v-model="ruleForm.ysfl" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.ysfl" label="颜色分类" prop="ysfl">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.ysfl}}</span>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='ysfl'){
							this.ruleForm.ysfl = obj[o];
							this.ro.ysfl = true;
							continue;
						}
						if(o=='huohao'){
							this.ruleForm.huohao = obj[o];
							this.ro.huohao = true;
							continue;
						}
						if(o=='laiyuan'){
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `mzfs/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.mzfsCrossAddOrUpdateFlag = false;
											this.parent.search();
