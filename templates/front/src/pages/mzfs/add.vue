...
<div :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="付款人数" prop="realsales">
            <el-input v-model="ruleForm.realsales" 
                placeholder="付款人数" clearable :disabled=" false  ||ro.realsales"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="商家" prop="shopname">
            <el-input v-model="ruleForm.shopname" 
                placeholder="商家" clearable :disabled=" false  ||ro.shopname"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="尺码" prop="chima">
            <el-input v-model="ruleForm.chima" 
                placeholder="尺码" clearable :disabled=" false  ||ro.chima"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="货号" prop="huohao">
            <el-input v-model="ruleForm.huohao" 
                placeholder="货号" clearable :disabled=" false  ||ro.huohao"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="颜色分类" prop="ysfl">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="颜色分类"
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`mzfs/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('mzfs/list', {
							...
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`mzfs/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
