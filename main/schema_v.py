...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spider5xczx9x5 && scrapy crawl "+tableName+"Spider -a databaseName=django4o1q4k01"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=django4o1q4k01"
        os.system(cmd)
