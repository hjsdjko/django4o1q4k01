...
class mzfs(BaseModel):
    ...
    realsales=models.CharField ( max_length=255, null=True, unique=False, verbose_name='付款人数' )
    shopname=models.CharField ( max_length=255, null=True, unique=False, verbose_name='商家' )
    chima=models.CharField ( max_length=255, null=True, unique=False, verbose_name='尺码' )
    pinpai=models.CharField ( max_length=255, null=True, unique=False, verbose_name='品牌' )
    ysfl=models.TextField   (  null=True, unique=False, verbose_name='颜色分类' )
    huohao=models.CharField ( max_length=255, null=True, unique=False, verbose_name='货号' )
    ...
    class Meta:
        db_table = 'mzfs'
        verbose_name = verbose_name_plural = '民族服饰'
class shujutongji(BaseModel):
    ...
    value=models.IntegerField  (  null=True, unique=False, verbose_name='服饰数量' )
...
class newstype(BaseModel):
    ...
    class Meta:
        db_table = 'newstype'
        verbose_name = verbose_name_plural = '服饰资讯分类'
class news(BaseModel):
    ...
    class Meta:
        db_table = 'news'
        verbose_name = verbose_name_plural = '服饰资讯'
...
class discussmzfs(BaseModel):
    __doc__ = u'''discussmzfs'''
    __tablename__ = 'discussmzfs'
    ...
    '''
    class Meta:
        db_table = 'discussmzfs'
        verbose_name = verbose_name_plural = 'mzfs评论表'
